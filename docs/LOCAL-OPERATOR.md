...
NEO_CORTEX_OPERATOR_WORKSPACE_ROOTS='["/Users/YOUR-MAC-USER/Developer/NEO-CORTEX-MACH1"]'
...
Workspace roots should name only repositories intended for review. The filesystem root and the user's home directory are rejected as over-broad roots. Do not allow `.ssh`, browser profiles, Keychain data, secret stores, or a general home/development directory.
